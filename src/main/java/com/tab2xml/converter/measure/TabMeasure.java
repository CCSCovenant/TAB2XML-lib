...
import com.tab2xml.converter.instruction.RepeatType;
import com.tab2xml.converter.instruction.TimeSignature;
import com.tab2xml.converter.measure_line.TabDrumString;
import com.tab2xml.converter.measure_line.TabGuitarString;
import com.tab2xml.converter.measure_line.TabString;
import com.tab2xml.converter.note.StartTieDecorator;
import com.tab2xml.converter.note.StopTieDecorator;
import com.tab2xml.converter.note.TabNote;
import com.tab2xml.models.measure.Backup;
import com.tab2xml.models.measure.Measure;
import com.tab2xml.models.measure.attributes.Attributes;
import com.tab2xml.models.measure.barline.BarLine;
import com.tab2xml.models.measure.barline.Repeat;
import com.tab2xml.models.measure.direction.Direction;
import com.tab2xml.models.measure.direction.DirectionType;
import com.tab2xml.models.measure.direction.Words;
...
//									+ (divisions + adjustment) + " to " + divisions);
    ...
    public Measure getModel() {
        ...
        List<Note> noteBeforeBackupModels = new ArrayList<>();
        List<Note> noteAfterBackupModels = new ArrayList<>();
