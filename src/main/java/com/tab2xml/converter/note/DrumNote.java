...
import com.tab2xml.converter.Instrument;
import com.tab2xml.models.measure.note.Note;
import com.tab2xml.models.measure.note.Notehead;
import com.tab2xml.models.measure.note.Unpitched;
import com.tab2xml.utility.DrumPiece;
import com.tab2xml.utility.DrumPieceInfo;
...
public class DrumNote extends TabNote{
    ...
    public Note getModel(){
        ...
        noteModel.setInstrument(new com.tab2xml.models.measure.note.Instrument(this.drumPieceInfo.getMidiID()));
