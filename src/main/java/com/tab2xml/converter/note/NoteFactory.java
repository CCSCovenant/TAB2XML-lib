...
import com.tab2xml.models.measure.note.Grace;
import com.tab2xml.models.measure.note.Note;
import com.tab2xml.models.measure.note.notations.Notations;
import com.tab2xml.models.measure.note.notations.Slur;
import com.tab2xml.models.measure.note.notations.technical.Technical;
...
public abstract class NoteFactory {
	...
	protected Technical getNonNullTechnical(Note noteModel) {
    ...
    protected Notations getNonNullNotations(Note noteModel) {
    	if (noteModel.getNotations() == null) noteModel.setNotations(new Notations());
	    Notations notations = noteModel.getNotations();
	    return notations;
    }
